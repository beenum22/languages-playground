...
impl<T> LinkedList<T> {
    ...
    pub fn push_front(&mut self, data: T) -> () {
        let mut new_node = AtomicReferenceCounter::new(Node {
            next: None,
            previous: None,
            data,
        });
...
mod node {
    ...
    fn test_set_next() {
        ...
        let next_link: Link<u8> = Some(AtomicReferenceCounter::new(Node {
            next: None,
            previous: None,
            data: 1u8,
        }));
    ...
    fn test_set_previous() {
        ...
        let prev_link: Link<u8> = Some(AtomicReferenceCounter::new(Node {
            next: None,
            previous: None,
            data: 1u8,
        }));
